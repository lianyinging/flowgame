...
/** 模型调用节点默认接口地址（DeepSeek Chat Completions） */
...
export const nodeLlmApi: CustomNode = {
  ...
  forms: [
    nodeFormHeading('模型接口'),
    {
      ...
      name: 'modelApiUrl',
      label: '模型接口地址',
      placeholder: DEFAULT_LLMAPI_MODEL_API_URL,
      defaultValue: DEFAULT_LLMAPI_MODEL_API_URL,
      description: '需为 Chat Completions 完整路径'
    },
    {
      type: 'input',
      name: 'apiKey',
    ...
    },
    {
      ...
      name: 'modelName',
      label: '模型名称',
      placeholder: DEFAULT_LLMAPI_MODEL_NAME,
      defaultValue: DEFAULT_LLMAPI_MODEL_NAME
    },
    {
      type: 'select',
      name: 'authType',
